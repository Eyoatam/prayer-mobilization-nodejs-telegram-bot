...
import { ExtraReplyMessage, ExtraEditMessage, Message } from 'telegraf/typings/telegram-types';
 ...
 */
export declare type EditMessageIntoMenuFunction<Context> = (chatId: number | string, messageId: number, context: Context, extra?: Readonly<ExtraEditMessage>) => Promise<Message | boolean>;
/**
 ...
 * @param extra optional additional Telegraf Extra options
 */
export declare function editMenuOnContext<Context extends TelegrafContext>(menu: MenuLike<Context>, context: Context, path: string, extra?: Readonly<ExtraEditMessage>): Promise<void>;
/**
